...
Color.niceColor = function(a) {
	a *= 6;
	var b = (a % 1) * 128 - 64; //from -64 to 64
	// var a = Math.random() * 6;
	// var b = Math.random() * 128 - 64;

	if(a < 1)      //   [255      128      0]
		return new Color(192 - b, 192 + b, 0);
	else if(a < 2) //   [128      255      0]
		return new Color(64 - b,  255,     64 + b);
	else if(a < 3) //   [0        255      128]
		return new Color(0,       192 - b, 192 + b);
	else if(a < 4) //   [0        128      255]
		return new Color(64 + b,  64 - b,  255);
	else if(a < 5) //   [128      0        255]
		return new Color(192 + b, 0,       192 - b);
	else           //   [255      0        128]
		return new Color(255,     64 + b,  64 - b);
}
